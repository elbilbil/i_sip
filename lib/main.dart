...
import 'package:i_sip/Menu.dart';
import 'package:i_sip/Player.dart';
import 'package:i_sip/Game.dart';
...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final HttpLink httpLink = HttpLink(
      uri: "https://i-sip.herokuapp.com/v1/graphql",
    );

    final WebSocketLink webSocketLink = WebSocketLink(
      url: 'wss://i-sip.herokuapp.com/v1/graphql',
